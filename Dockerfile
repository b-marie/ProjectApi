...
COPY ["src/projectApi.Api/projectApi.Common.csproj", "src/projectApi.Common/"]
COPY ["src/projectApi.Api/projectApi.Service.csproj", "src/projectApi.Service/"]
RUN dotnet restore "src/projectApi.Api/projectApi.Api.csproj"
RUN dotnet restore "src/projectApi.Api/projectApi.Common.csproj"
RUN dotnet restore "src/projectApi.Api/projectApi.Service.csproj"
COPY . .
